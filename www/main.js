(self["webpackChunkerp_proj"] = self["webpackChunkerp_proj"] || []).push([["main"],{
...
const routes = [
    ...
    {
        path: 'items',
        loadChildren: () => Promise.all(/*! import() */[__webpack_require__.e("default-src_app_modalComponents_selected-item-modal_selected-item-modal_module_ts"), __webpack_require__.e("common"), __webpack_require__.e("src_app_pages_items_items_module_ts")]).then(__webpack_require__.bind(__webpack_require__, /*! ./pages/items/items.module */ 7272)).then(m => m.ItemsPageModule)
    },
    {
        path: 'purchases',
        loadChildren: () => __webpack_require__.e(/*! import() */ "src_app_pages_purchases_purchases_module_ts").then(__webpack_require__.bind(__webpack_require__, /*! ./pages/purchases/purchases.module */ 6586)).then(m => m.PurchasesPageModule)
    },
    {
        path: 'invoices',
        loadChildren: () => Promise.all(/*! import() */[__webpack_require__.e("default-src_app_modalComponents_selected-item-modal_selected-item-modal_module_ts"), __webpack_require__.e("src_app_pages_invoices_invoices_module_ts")]).then(__webpack_require__.bind(__webpack_require__, /*! ./pages/invoices/invoices.module */ 9093)).then(m => m.InvoicesPageModule)
    },
    {
        path: 'promotions',
        loadChildren: () => __webpack_require__.e(/*! import() */ "src_app_pages_promotions_promotions_module_ts").then(__webpack_require__.bind(__webpack_require__, /*! ./pages/promotions/promotions.module */ 4303)).then(m => m.PromotionsPageModule)
    },
    {
        path: 'add-item-modal',
        loadChildren: () => __webpack_require__.e(/*! import() */ "common").then(__webpack_require__.bind(__webpack_require__, /*! ./modalComponents/add-item-modal/add-item-modal.module */ 6680)).then(m => m.addItemModalComponentModule)
    },
    {
        path: 'stocks',
        loadChildren: () => Promise.all(/*! import() */[__webpack_require__.e("common"), __webpack_require__.e("src_app_pages_stocks_stocks_module_ts")]).then(__webpack_require__.bind(__webpack_require__, /*! ./pages/stocks/stocks.module */ 983)).then(m => m.StocksPageModule)
    },
    {
        path: 'login',
...
/* harmony import */ var _services_api_calls_service__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ./services/api-calls.service */ 54);
...
/* harmony import */ var angular_disable_browser_back_button__WEBPACK_IMPORTED_MODULE_7__ = __webpack_require__(/*! angular-disable-browser-back-button */ 2637);
...
AppModule = (0,tslib__WEBPACK_IMPORTED_MODULE_2__.__decorate)([
    (0,_angular_core__WEBPACK_IMPORTED_MODULE_3__.NgModule)({
        ...
        imports: [
            ...
            angular_disable_browser_back_button__WEBPACK_IMPORTED_MODULE_7__.BackButtonDisableModule.forRoot()
        ],
        providers: [{ provide: _angular_router__WEBPACK_IMPORTED_MODULE_8__.RouteReuseStrategy, useClass: _ionic_angular__WEBPACK_IMPORTED_MODULE_5__.IonicRouteStrategy }, _angular_forms__WEBPACK_IMPORTED_MODULE_9__.FormBuilder],
...
let ApiCallsService = class ApiCallsService {
    constructor(httpClient, loadingController, alertcontroller, router, location) {
        this.httpClient = httpClient;
        this.loadingController = loadingController;
        this.alertcontroller = alertcontroller;
        this.router = router;
        this.location = location;
        this.itemEndpoint = 'https://test-backend-neon.vercel.app/api/item/';
        this.stocksEndpoint = 'https://test-backend-neon.vercel.app/api/stock/';
        this.branchesEndpoint = 'https://test-backend-neon.vercel.app/api/branch/';
        this.loginEndpoint = 'https://test-backend-neon.vercel.app/api/auth/signin';
        this.reportsEndpoint = 'https://test-backend-neon.vercel.app/api/report/';
        this.invoiceEndpoint = 'https://test-backend-neon.vercel.app/api/invoice/';
        this.httpOptions = {
            headers: new _angular_common_http__WEBPACK_IMPORTED_MODULE_0__.HttpHeaders({ 'Content-Type': 'application/json' })
        };
        //used in login page
        this.requirePane = false;
    ...
    createItem(item) {
        return this.httpClient.post(this.itemEndpoint, JSON.stringify(item), this.httpOptions);
    }
    updateItem(item, itemIid) {
        return this.httpClient.put(this.itemEndpoint + itemIid, JSON.stringify(item), this.httpOptions);
    }
    deleteItem(itemIid) {
    ...
    deleteStocks(itemId, _branchCode, _qty) {
        return this.httpClient.put(this.stocksEndpoint + "update/" + _branchCode + "/" + itemId + "/" + _qty, this.httpOptions);
    }
    getBranches() {
    ...
    //#region user_login
    userLogin(creds) {
        return this.httpClient.post(this.loginEndpoint, JSON.stringify(creds), this.httpOptions);
    }
    //#endregion
    //#region Reports_tab
...
ApiCallsService = (0,tslib__WEBPACK_IMPORTED_MODULE_1__.__decorate)([
...
/* harmony export */   "default": () => (__WEBPACK_DEFAULT_EXPORT__)
/* harmony export */ });
/* harmony default export */ const __WEBPACK_DEFAULT_EXPORT__ = ("<ion-app>\n  <ion-split-pane contentId=\"main-content\">\n    <ion-menu contentId=\"main-content\" type=\"overlay\" [disabled] = \"!apicalls.requirePane\">\n      <ion-content>\n        <ion-list id=\"inbox-list\">\n          <ion-list-header>Dewmin Motor House</ion-list-header>\n          <ion-note></ion-note>\n\n          <ion-menu-toggle auto-hide=\"false\" *ngFor=\"let p of appPages; let i = index\">\n            <ion-item routerDirection=\"root\" [routerLink]=\"[p.url]\" lines=\"none\" detail=\"false\" routerLinkActive=\"selected\">\n              <ion-icon slot=\"start\" [ios]=\"p.icon + '-outline'\" [md]=\"p.icon + '-sharp'\"></ion-icon>\n              <ion-label>{{ p.title }}</ion-label>\n            </ion-item>\n          </ion-menu-toggle>\n        </ion-list>\n      </ion-content>\n      <ion-footer>\n        <ion-button expand=\"full\" color= \"danger\" (click) = \"apicalls.logOut()\">\n          Log-out\n        </ion-button>\n      </ion-footer>\n    </ion-menu>\n    <ion-router-outlet id=\"main-content\"></ion-router-outlet>\n  </ion-split-pane>\n</ion-app>\n");
